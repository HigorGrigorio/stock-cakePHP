...
return [
    ...
    'prev' => '<li class="page-item"><a href="{{url}}" class="page-link">{{text}}</a><li>',
    ...
    'nextDisabled' => '<li class="page-item disable"><a href="{{url}}" class="page-link">{{text}}</a><li>',
    'prevDisabled' => '<li class="page-item disable"><a href="{{url}}" class="page-link">{{text}}</a><li>',
